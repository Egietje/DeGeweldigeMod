...
public class CheeseFurnace extends BlockContainer {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.isRemote) {
			...
			if (tileentity instanceof TileEntityCheeseFurnace) {
				playerIn.displayGUIChest((TileEntityCheeseFurnace) tileentity);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityCheeseFurnace();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityCheeseFurnace) {
				((TileEntityCheeseFurnace) tileentity).setCustomInventoryName(stack.getDisplayName());
			}
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		if (!keepInventory) {
			...
			if (tileentity instanceof TileEntityCheeseFurnace) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityCheeseFurnace) tileentity);
