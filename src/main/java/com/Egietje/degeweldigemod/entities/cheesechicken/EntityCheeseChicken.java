...
public class EntityCheeseChicken extends EntityAnimal {
	...
	public EntityCheeseChicken(World worldIn) {
		super(worldIn);
	...
	public EntityCheeseChicken createChild(EntityAgeable ageable) {
		return new EntityCheeseChicken(this.worldObj);
	}
