...
public class StructureCheeseVillagePieces {
	public static void registerVillagePieces() {
		...
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Start.class, "CViStart");
	...
	public static List<StructureVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random,
		...
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.House4Garden.class, 4,
				MathHelper.getRandomIntegerInRange(random, 2 + size, 4 + size * 2)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.Church.class, 20,
				MathHelper.getRandomIntegerInRange(random, 0 + size, 1 + size)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.House1.class, 20,
				MathHelper.getRandomIntegerInRange(random, 0 + size, 2 + size)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.WoodHut.class, 3,
				MathHelper.getRandomIntegerInRange(random, 2 + size, 5 + size * 3)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.Hall.class, 15,
				MathHelper.getRandomIntegerInRange(random, 0 + size, 2 + size)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.Field1.class, 3,
				MathHelper.getRandomIntegerInRange(random, 1 + size, 4 + size)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.Field2.class, 3,
				MathHelper.getRandomIntegerInRange(random, 2 + size, 4 + size * 2)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.House2.class, 15,
				MathHelper.getRandomIntegerInRange(random, 0, 1 + size)));
		list.add(new StructureVillagePieces.PieceWeight(StructureCheeseVillagePieces.House3.class, 8,
	...
	private static StructureVillagePieces.Village findAndCreateComponentFactory(StructureVillagePieces.Start start,
		...
		if (oclass == StructureCheeseVillagePieces.House4Garden.class) {
			...
			structurevillagepieces$village = net.minecraftforge.fml.common.registry.VillagerRegistry
					.getVillageComponent(weight, start, structureComponents, rand, structureMinX, structureMinY,
	...
	public static class Church extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.Church createPiece(StructureVillagePieces.Start start,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			if (this.getBlockStateFromPos(worldIn, 2, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR
				...
				if (this.getBlockStateFromPos(worldIn, 2, -1, -1, structureBoundingBoxIn)
					...
					this.setBlockState(worldIn, CheeseBlocks.CHEESE_GRASS.getDefaultState(), 2, -1, -1,
	...
	public static class Field1 extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.Field1 createPiece(StructureVillagePieces.Start start,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 0, 12, 4, 8, Blocks.AIR.getDefaultState(),
					Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 2, 0, 7,
					CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(), CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(),
					false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 0, 1, 5, 0, 7,
					CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(), CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(),
					false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 0, 1, 8, 0, 7,
					CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(), CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(),
					false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10, 0, 1, 11, 0, 7,
					CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(), CheeseBlocks.CHEESE_FARM_LAND.getDefaultState(),
					false);
			...
			for (int i = 1; i <= 7; ++i) {
				...
				this.setBlockState(worldIn,
						this.cropTypeA.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, k, j)), 1, 1, i,
						structureBoundingBoxIn);
				this.setBlockState(worldIn,
						this.cropTypeA.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, k, j)), 2, 1, i,
						structureBoundingBoxIn);
				int l = ((BlockCrops) this.cropTypeB).getMaxAge();
				int i1 = l / 3;
				this.setBlockState(worldIn,
						this.cropTypeB.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, i1, l)), 4, 1, i,
						structureBoundingBoxIn);
				this.setBlockState(worldIn,
						this.cropTypeB.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, i1, l)), 5, 1, i,
						structureBoundingBoxIn);
				int j1 = ((BlockCrops) this.cropTypeC).getMaxAge();
				int k1 = j1 / 3;
				this.setBlockState(worldIn,
						this.cropTypeC.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, k1, j1)), 7, 1, i,
						structureBoundingBoxIn);
				this.setBlockState(worldIn,
						this.cropTypeC.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, k1, j1)), 8, 1, i,
						structureBoundingBoxIn);
				int l1 = ((BlockCrops) this.cropTypeD).getMaxAge();
				int i2 = l1 / 3;
				this.setBlockState(worldIn,
						this.cropTypeD.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, i2, l1)), 10, 1, i,
						structureBoundingBoxIn);
				this.setBlockState(worldIn,
						this.cropTypeD.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, i2, l1)), 11, 1, i,
						structureBoundingBoxIn);
			}
	...
	public static class Field2 extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.Field2 createPiece(StructureVillagePieces.Start start,
	...
	public static class Hall extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.Hall createPiece(StructureVillagePieces.Start start,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 1, 6, 8, 4, 10, Blocks.AIR.getDefaultState(),
					Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 0, 6, 8, 0, 10,
					CheeseBlocks.CHEESE_DIRT.getDefaultState(), CheeseBlocks.CHEESE_DIRT.getDefaultState(), false);
	...
	public static class House1 extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.House1 createPiece(StructureVillagePieces.Start start,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.setBlockState(worldIn, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 4, 2, 3,
					structureBoundingBoxIn);
			this.setBlockState(worldIn, CheeseBlocks.CHEESE_CRAFTING_TABLE.getDefaultState(), 7, 1, 1,
					structureBoundingBoxIn);
			...
			if (this.getBlockStateFromPos(worldIn, 1, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR
				...
				if (this.getBlockStateFromPos(worldIn, 1, -1, -1, structureBoundingBoxIn)
						.getBlock() == CheeseBlocks.CHEESE_GRASS_PATH) {
					this.setBlockState(worldIn, CheeseBlocks.CHEESE_GRASS.getDefaultState(), 1, -1, -1,
							structureBoundingBoxIn);
				}
			}
	...
	public static class House2 extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.House2 createPiece(StructureVillagePieces.Start start,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			if (!this.hasMadeChest && structureBoundingBoxIn.isVecInside(
				...
				this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 5, 1, 5, LootTables.CHESTS_CHEESE);
			}
			...
			for (int i = 6; i <= 8; ++i) {
				if (this.getBlockStateFromPos(worldIn, i, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR
					...
					if (this.getBlockStateFromPos(worldIn, i, -1, -1, structureBoundingBoxIn)
							.getBlock() == CheeseBlocks.CHEESE_GRASS_PATH) {
						this.setBlockState(worldIn, CheeseBlocks.CHEESE_GRASS.getDefaultState(), i, -1, -1,
								structureBoundingBoxIn);
					}
				}
			}
	...
	public static class House3 extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.House3 createPiece(StructureVillagePieces.Start start,
	...
	public static class House4Garden extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.House4Garden createPiece(StructureVillagePieces.Start start,
	...
	public static class Path extends StructureCheeseVillagePieces.Road {
		...
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null) {
				...
				case NORTH:
				default:
					StructureCheeseVillagePieces.generateAndAddRoadPiece((StructureVillagePieces.Start) componentIn,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate5 = this
					.getBiomeSpecificBlockState(CheeseBlocks.CHEESE_GRASS_PATH.getDefaultState());
				...
				for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
					...
					if (structureBoundingBoxIn.isVecInside(blockpos)) {
						...
						while (blockpos.getY() >= worldIn.getSeaLevel() - 1) {
							...
							if (iblockstate4.getBlock() == CheeseBlocks.CHEESE_GRASS
							...
							if (iblockstate4.getBlock() == CheeseBlocks.CHEESE_GRASS
									&& worldIn.isAirBlock(blockpos.up())) {
								worldIn.setBlockState(blockpos, iblockstate5, 2);
								break;
							}
	...
	public static class Well extends StructureVillagePieces.Village {
		 ...
		 */
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
			StructureCheeseVillagePieces.generateAndAddRoadPiece((StructureVillagePieces.Start) componentIn, listIn,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			for (int i = 0; i <= 5; ++i) {
				for (int j = 0; j <= 5; ++j) {
					if (j == 0 || j == 5 || i == 0 || i == 5) {
						this.setBlockState(worldIn, CheeseBlocks.CHEESE_BLOCK.getDefaultState(), j, 11, i,
								structureBoundingBoxIn);
	...
	public static class WoodHut extends StructureVillagePieces.Village {
		...
		public static StructureCheeseVillagePieces.WoodHut createPiece(StructureVillagePieces.Start start,
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 2, 0, 3,
					CheeseBlocks.CHEESE_DIRT.getDefaultState(), CheeseBlocks.CHEESE_DIRT.getDefaultState(), false);
